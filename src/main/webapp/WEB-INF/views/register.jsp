  ...
  <div id="login" class="container">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form:form modelAttribute="registerUserForm" action="${pageContext.request.contextPath}/registerUser/register" method="POST">
          ...
          <div class="form-group">
            ...
            <form:input type="password" path="password" class="form-control" id="password" placeholder="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="パスワードは半角英数字 8~16文字で入力してください。" />
          </div>
